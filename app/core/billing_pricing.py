...
def map_price_id_to_plan_and_billing(price_id: str) -> tuple[str, str] | None:
    ...
    - plan: semantic tier (starter/pro)
    - billing_price: actual price variant (starter/pro/pro_founder/pro_legacy_149)
    """
    ...
    if price_id == settings.STRIPE_PRO_LEGACY_149_PRICE_ID:
        return "pro", "pro_legacy_149"
